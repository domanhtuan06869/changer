...
Dự án về tool change và auto trên phone thật.
...
`app` - files within this folder get transpiled or compiled. Put here images, CSSes, HTMLs, etc.
...
To set icon
```
electron-packager ./ --platform=win32 --arch=x64 --icon=logo_xpro.ico
```

Once the packaging process finished, the `out` directory will contain your distributable file.
